<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="邮编" prop="youbian">
          <el-input v-model="ruleForm.youbian" 
              placeholder="邮编" clearable  :readonly="ro.youbian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="邮编" prop="youbian">
              <el-input v-model="ruleForm.youbian" 
                placeholder="邮编" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gongsijianjie" label="公司简介" prop="gongsijianjie">
                    <span v-html="ruleForm.gongsijianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiyeyouxiang = true;
          ...
          if(o=='youbian'){
            this.ruleForm.youbian = obj[o];
	    this.ro.youbian = true;
            continue;
          }
          if(o=='gongsifengmian'){
	...
	this.ruleForm.gongsijianjie = this.ruleForm.gongsijianjie.replace(reg,'../../../ssm4t5c4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `lianxiwomen/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lianxiwomenCrossAddOrUpdateFlag = false;
                  this.parent.search();
